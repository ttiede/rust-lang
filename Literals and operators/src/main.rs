fn main() {
    ...
    println!("00100110u << 2 is {}", 00100110u << 2);
    println!("0x80 >> 2 is 0x{:x}", 0x80u >> 2);

    // Use underscores to improve readability!
    println!("One trillion is written as {}", 1_000_000_000_000u);

    
    println!("One billion is written as {}", 1_000_000_000u);
    println!("One million is written as {}", 1_000_000u);
    println!("One thousand is written as {}", 1_000u);
